...
var _FormOption = _interopRequireDefault(require("./FormOption"));
...
var FormInputRender = _react.default.forwardRef(function (props, ref) {
  var item = props.item,
      intl = props.intl,
      form = props.form,
      type = props.type,
  ...
  if (item.renderFormItem) {
    ...
    var defaultRender = function defaultRender(newItem) {
      return /*#__PURE__*/_react.default.createElement(FormInputRender, _objectSpread(_objectSpread({}, props), {}, {
        item: newItem
      }) || null);
...
var proFormItemRender = function proFormItemRender(_ref) {
  ...
  var key = (0, _utils.genColumnKey)(rest.key, index);

  var dom = /*#__PURE__*/_react.default.createElement(FormInputRender, {
    item: item,
    type: type,
    intl: intl,
    form: formInstance
  ...
  return /*#__PURE__*/_react.default.createElement(_col.default, _extends({}, colConfig, {
    key: key
  ...
  Object.keys(value).forEach(function (key) {
    ...
    if (Array.isArray(itemValue) && itemValue.length === 2 && dateFormatter) {
      if (dateFormatter === 'string') {
        ...
        tmpValue[key] = [startValue && (0, _moment.default)(startValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'), endValue && (0, _moment.default)(endValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss')];
        return;
      }
...
var FormSearch = function FormSearch(_ref2) {
  ...
  var _useMergedState = (0, _useMergedState3.default)(true, {
  ...
  (0, _proUtils.useDeepCompareEffect)(function () {
    ...
    counter.proColumns.forEach(function (item) {
      tempMap[(0, _utils.genColumnKey)(item.key, item.index)] = item;
    });
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_form.default, _extends({}, formConfig, {
    form: form,
    onValuesChange: function onValuesChange() {
      return forceUpdate();
    },
    initialValues: columnsList.reduce(function (pre, item) {
      var key = (0, _utils.genColumnKey)(item.key, item.index);
    ...
    shouldUpdate: true,
    noStyle: true
  }, /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, domList)), /*#__PURE__*/_react.default.createElement(_col.default, _extends({}, colConfig, {
    ...
    label: isForm && ' '
  }, /*#__PURE__*/_react.default.createElement(_FormOption.default, {
