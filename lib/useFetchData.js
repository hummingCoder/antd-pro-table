...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var mountRef = (0, _react.useRef)(true);
  ...
  var prePage = (0, _proUtils.usePrevious)(pageInfo.page);
  var prePageSize = (0, _proUtils.usePrevious)(pageInfo.pageSize);
  ...
  var fetchListDebounce = (0, _proUtils.useDebounceFn)(fetchList, [], 200);
